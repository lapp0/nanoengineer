...
"""
This class provides the flyout toolbar for ExtrudeMode
...
History:
2008-09-19: Created during command stack refactoring project
...
class ExtrudeFlyout(Ui_AbstractFlyout):
    def _action_in_controlArea_to_show_this_flyout(self):
        ...
        """
        return self.win.toolsExtrudeAction
